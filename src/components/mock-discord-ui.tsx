...
const MockDiscordUi = ({ children }: PropsWithChildren) => {
  return (
    <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-xl overflow-hidden shadow-xl">
      {/* {server list} */}
      <div className="hidden sm:flex w-[72px] bg-[#202225]  py-3 flex-col items-center">
        ...
        {[...Array(5)].map((_, index) => (
          <div
            className="bg-discord-background size-12 rounded-3xl flex items-center mb-3 justify-center hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-color cursor-not-allowed"
            key={index}
          >
        ...
        <div className="bg-discord-background group mt-auto size-12 rounded-3xl flex items-center mb-3 justify-center hover:rounded-xl transition-all duration-200 hover:bg-[#3BA55C] cursor-not-allowed">
      ...
      <div className="hidden md:flex w-60 bg-[#2F3136] flex-col">
            ...
            <div className="my-1 space-y-px">
              {[...Array(4)].map((_, i) => (
                <div
                  ...
                  key={i}
                >
                  <div className="size-8 rounded-full mr-3 bg-discord-background" />
        ...
        <div className="py-2 bg-[#292B2F] flex items-center">
          <div className="size-8 rounded-full bg-brand-700 mr-2" />
          <div className="flex-1">
            <p className="text-sm font-medium text-white">You</p>
            <p className="text-xs text-[#B9BBBE] items-center">@your_account</p>
          </div>
          ...
          <div className="flex items-center">
            <div className="relative">
              <Image
                ...
                className="object-cover rounded-full mr-3"
              />
              <div className="absolute bottom-0 right-3 size-3 bg-green-500 border-2 rounded-full border-[#36393F]" />
            </div>
        ...
        <div className="p-4">
          <div className="flex items-center bg-[#40444B] rounded-lg p-1">
            ...
            <input
              ...
              className="flex-1 bg-transparent py-2.5 text-white placeholder-[#72767D] focus:outline-none cursor-not-allowed"
            />
